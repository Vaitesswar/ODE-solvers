...
xlabel('\Upsilon')
ylabel('\phi')
title(['Plot of \phi against \Upsilon (Shooting method (RK4) for n = ', num2str(n), ')']) 	
toc
%% RK2 method
tic
y0_possible = 0:0.0001:1;
...
xlabel('\Upsilon')
ylabel('\phi')
title(['Plot of \phi against \Upsilon (Shooting method (RK2) for n = ', num2str(n), ')']) 
toc
%% Euler method
tic
y0_possible = 0:0.0001:1;
...
xlabel('\Upsilon')
ylabel('\phi')
title(['Plot of \phi against \Upsilon (Shooting method (Euler) for n = ', num2str(n), ')']) 
toc